...
- 食後2-4時間で低血糖が起こることが特徴で、精神神経症状が起こる

## PGBHについて

- Roux-en-Y gastric bypass (RYGB) surgeryの後の低血糖
- 以前は晩期Dumping症候群と言われていた
- Etiologyははっきり分かっていないが、複数のHormon異常が原因とされている
...
1. 副腎不全を否定する[@Adrian-hypoglycemia-determining]
2. 問診を重視
→理論的というよりは、実践的
...
1. 薬剤性を病歴から否定はUptoDateと一緒[@DynaMed_hypoglycemia]
